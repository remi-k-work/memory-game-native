...
function DialogOverlayNative({
  ...
  return (
    <DialogPrimitive.Overlay style={StyleSheet.absoluteFill} className={cn("flex items-center justify-center bg-black/80 p-2", className)} {...props}>
...
function DialogTitle({
  ...
  return <DialogPrimitive.Title className={cn("native:text-xl text-lg font-semibold leading-none tracking-tight text-foreground", className)} {...props} />;
}
...
function DialogDescription({
  ...
  return <DialogPrimitive.Description className={cn("native:text-base text-sm text-muted-foreground", className)} {...props} />;
}
