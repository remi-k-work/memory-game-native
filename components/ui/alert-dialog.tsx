...
function AlertDialogOverlayNative({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      className={cn("absolute bottom-0 left-0 right-0 top-0 z-50 flex items-center justify-center bg-black/80 p-2", className)}
      {...props}
      asChild
    >
...
function AlertDialogTitle({
  ...
  return <AlertDialogPrimitive.Title className={cn("native:text-xl text-lg font-semibold text-foreground", className)} {...props} />;
}
...
function AlertDialogDescription({
  ...
  return <AlertDialogPrimitive.Description className={cn("native:text-base text-sm text-muted-foreground", className)} {...props} />;
}
