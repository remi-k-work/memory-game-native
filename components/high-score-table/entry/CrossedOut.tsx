...
export default function CrossedOutEntry() {
  ...
  const { animStyleCrossOutLine1, animStyleCrossOutLine2 } = useAnimCrossedOutEntry(entrySize);

  return (
    <TableCell className="pointer-events-none" style={StyleSheet.absoluteFill} onLayout={(ev) => setEntrySize(ev.nativeEvent.layout)}>
